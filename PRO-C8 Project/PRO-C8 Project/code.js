...
function draw() {
  ...
  // Score
     ...
     if(striker.isTouching(goal1))
      ...
      if(playerScore==5) //add the condition to check  either of the player’s score reaches 5

      {
        fill("maroon");
        textSize(18);
        //add the text for GameOver
        text(" Game Over, Player Wins ",170,160);
      }
 ...
 if (compScore==5) {
   fill("maroon");
        textSize(18);
        //add the text for GameOver
        text(" Game Over, Computer Wins ",170,160);
 }
